...
const AvatarCard = ({avatar}) => {
  ...
  return (
    <div className="bg-purple-700 hover:bg-purple-600 p-4 shadow-lg rounded-lg flex flex-col items-center min-w-[300px] duration-300 hover:scale-105 active:scale-105 hover:shadow-[0px_0px_10px_rgba(34,197,94,0.6)] active:shadow-[0px_0px_10px_rgba(34,197,94,0.6)]  cursor-pointer">
